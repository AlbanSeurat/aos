...
use crate::core::core_reset::CoreFifoFlush;
...
use crate::core::core_usb_cfg::USB_CONFIG::PHYSICAL_INTERFACE::Value::Width16bit;
...
use crate::core::core_hard_config::HCD_HARDWARE_CONFIG_2::OPERATING_MODE::Value::{HNP_SRP_CAPABLE,
                                                                                 ...
                                                                                 SRP_CAPABLE_HOST,
                                                                                 SRP_ONLY_CAPABLE};
use mmio::macros::_debug;

pub mod core_ahb;
pub mod core_hard_config;
pub mod core_reset;
pub mod core_usb_cfg;
pub mod core_irq;
mod core_periodic_info;
pub mod core_otg_ctrl;
